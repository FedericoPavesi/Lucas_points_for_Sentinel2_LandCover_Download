...
for raster_name in os.listdir(rasterpath):
    ...
    try:
        for model in os.listdir(modelpath)[:2]:
            ...
            print('Model loaded!')
            savepath = 'C:/Users/drikb/Desktop/Tirocinio/EarthEngine/Codes_for_variability_evaluation/Predictions/RF3x3/trial_' + model[-1] + '/'
...
for raster_name in os.listdir(rasterpath):
    ...
    try:
        for model in os.listdir(modelpath):
            ...
            savepath = 'C:/Users/drikb/Desktop/Tirocinio/EarthEngine/Codes_for_variability_evaluation/Predictions/MLP3x3/trial_' + model[-1] + '/'
